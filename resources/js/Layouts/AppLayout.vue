<template>
    <div>
        ...
        <div class="min-h-screen dark:bg-gray-900 bg-gray-100">
            <nav class="dark:bg-gray-800 bg-white border-b dark:border-gray-800 border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex flex-wrap">
                                ...
                                <jet-nav-link v-show="$page.props.permissions.canListOwnTickets" :href="route('tickets.index')" :active="route().current('tickets.*')">
                                    Tickets
                                </jet-nav-link>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <div class="ml-3 relative">
                                <!-- Teams Dropdown -->
                                <jet-dropdown align="right" width="60" v-if="$page.props.jetstream.hasTeamFeatures && ($page.props.jetstream.canCreateTeams || $page.props.permissions.canViewTeamSettings | $page.props.permissions.canSwitchTeams)">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:bg-gray-900 dark:hover:bg-gray-800 bg-white hover:bg-gray-50 dark:hover:text-gray-300 hover:text-gray-700 focus:outline-none dark:focus:bg-gray-800 focus:bg-gray-50 dark:active:bg-gray-800 active:bg-gray-50 transition">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                                <div v-if="$page.props.jetstream.canCreateTeams || $page.props.permissions.canViewTeamSettings" class="block px-4 py-2 text-xs text-gray-400">
                                                    Manage Team
                                                </div>
                                                ...
                                                <!-- Team Switcher -->
                                                <div v-if="$page.props.permissions.canSwitchTeams" class="block px-4 py-2 text-xs text-gray-400">
                                                    Switch Teams
                                                </div>

                                                <template v-if="$page.props.permissions.canSwitchTeams" v-for="team in $page.props.user.all_teams" :key="team.id">
