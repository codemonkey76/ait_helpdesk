            ...
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow overflow-hidden sm:rounded-lg">
                    <table class="min-w-full divide-y dark:divide-gray-600 divide-gray-200">
                        ...
                        <tbody>
                        <tr v-if="!users.data.length" class="dark:odd:bg-gray-900 dark:even:bg-gray-800 odd:bg-white even:bg-gray-50">
                            <td colspan="5"
                                class="px-6 py-4 whitespace-nowrap text-sm font-medium dark:text-gray-400 text-gray-500 text-center italic">
                                Nothing to show
                            </td>
                        </tr>
                        <user-row v-for="(user,key) in users.data" :key="key" :user="user" />
                        </tbody>
                        <tfoot>
                        <tr>
                            <th scope="col" colspan="5">
                                <jet-paginator :data="users"></jet-paginator>
                            </th>
                        </tr>
                        </tfoot>
                    </table>
