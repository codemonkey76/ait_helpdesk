...
<!--    <div class="dark:bg-gray-800 bg-white pt-10 pb-10 px-4 sm:px-6 lg:px-8 rounded-md shadow-lg">-->
        <div class="relative max-w-lg mx-auto divide-y-2 dark:divide-gray-600 divide-gray-200 lg:max-w-7xl">
            <div>
                ...
                <p class="mt-3 text-lg dark:text-gray-400 text-gray-500 sm:mt-4" v-text="response.subject"/>
            </div>
            <div class="mt-4 pt-6">
                <div>
                    <a href="#" class="block mt-4">
                        <p class="mt-3 text-base dark:text-gray-400 text-gray-500" v-text="response.content"/>
                    </a>
                    <div class="mt-4 flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium dark:text-gray-200 text-gray-900" v-text="response.user?.name" />
