        ...
        Inertia::share(array_filter([
            'permissions' => function () use ($request) {
                return [
                    ...
                    'canEditNotes'           => $request->user()?->hasPermissionTo('edit notes'),
                    ...
                    'canEditAllJobs'         => $request->user()?->hasPermissionTo('edit all jobs'),
                    'canDeleteAllJobs'       => $request->user()?->hasPermissionTo('delete all jobs'),
                    'canEditOwnJob'          => $request->user()?->hasPermissionTo('edit own job'),
                    'canDeleteOwnJob'        => $request->user()?->hasPermissionTo('delete own job'),
